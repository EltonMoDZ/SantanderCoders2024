...
public class AgendaContatos {
    static String[][] contatos = new String[100][5];
    static int indice = 0;
    ...
    private static void adicionarContato(String[][] contatos, Scanner sc, int indice) {
        try {
            ...
            String email = AgendaServices.adicionarEmail(contatos, sc);
            String telefone = AgendaServices.adicionarTelefone(contatos, sc);
            String telefone2 = AgendaServices.adicionarTelefone2(contatos, sc);
            String endereco = AgendaServices.adicionarEndereco(contatos, sc);


            contatos[indice][0] = nome;
            contatos[indice][1] = telefone;
            contatos[indice][2] = telefone2;
            contatos[indice][3] = email;
        ...
        try {
            ...
            for (String[] contato : contatos) {
                if (AgendaServices.checarSeContatoExiste(contatos, telefone)) {
                    System.out.println("\n-----Informações-----");
                    System.out.println("Nome: " + contato[0] + "\t|Telefone: " + contato[1] + "\t|Telefone 2: " + contato[2] + "\t |E-mail: " + contato[3] + "\n|" + contato[4]);
                    break;
                } else {
        ...
        try {
            ...
            for (int i = 0; i < contatos.length; i++) {
                if (contatos[i][1] != null && contatos[i][1].equals(telefone)) {
                    ...
                    contatos[i][2] = novoTelefone;
                    contatos[i][3] = novoEmail;
