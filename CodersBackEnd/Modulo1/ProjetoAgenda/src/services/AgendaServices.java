...
public class AgendaServices {
    ...
    public static boolean checarSeContatoExiste(String[][] contatos, String telefone) {
        try {
            for (String[] contato : contatos) {
                if ((contato[1] != null && contato[1].equals(telefone)) || (contato[2] != null && contato[2].equals(telefone))) {
                    return true;
                }
            }
    ...
    public static String adicionarTelefone2(String[][] contatos, Scanner sc) {
        String telefone = "";
        boolean telefoneValido = false;
    ...
    public static String adicionarEmail(String[][] contatos, Scanner sc){
    ...
    public static String adicionarEndereco(String[][] contatos, Scanner sc) {
        String cep;
        String logradouro;
        String numero;
        String bairro;
        ...
        return String.format("Endereço do contato:\n-CEP: %s\n-Logradouro: %s\n-Número: %s\n-Bairro: %s\n-Cidade: %s\s-Estado: %s", cep, logradouro, numero, bairro, cidade, estado);
    }
